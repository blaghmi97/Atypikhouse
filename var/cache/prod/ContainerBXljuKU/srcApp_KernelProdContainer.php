...
class srcApp_KernelProdContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('Z4ve9TLjXC', 0, ($this->targetDir.''.'/pools'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL))));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('wUbmug+TZP', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ybHcfiZBve', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.property_access'] = \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('imAMbDEMwM', 0, $this->getParameter('container.build_id'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.property_info'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Kmqz5zUMJx', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('yMYKJHHB0j', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.serializer'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('GmyKBjLpjv', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.validator'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('gVI2sX52KG', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        $this->privates['doctrine.result_cache_pool'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('abrGwE+7bE', 0, ($this->targetDir.''.'/pools'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL))));
    ...
    {
        return $this->privates['doctrine.system_cache_pool'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('xhrHejIqAg', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
...
{
    private $valueHolderfe70a = null;
    private $initializerdc9e5 = null;
    private static $publicPropertiesdbf17 = [
        
    ];
    public function getConnection()
    {
        $this->initializerdc9e5 && ($this->initializerdc9e5->__invoke($valueHolderfe70a, $this, 'getConnection', array(), $this->initializerdc9e5) || 1) && $this->valueHolderfe70a = $valueHolderfe70a;
        return $this->valueHolderfe70a->getConnection();
    }
    public function getMetadataFactory()
    {
        $this->initializerdc9e5 && ($this->initializerdc9e5->__invoke($valueHolderfe70a, $this, 'getMetadataFactory', array(), $this->initializerdc9e5) || 1) && $this->valueHolderfe70a = $valueHolderfe70a;
        return $this->valueHolderfe70a->getMetadataFactory();
    }
    public function getExpressionBuilder()
    {
        $this->initializerdc9e5 && ($this->initializerdc9e5->__invoke($valueHolderfe70a, $this, 'getExpressionBuilder', array(), $this->initializerdc9e5) || 1) && $this->valueHolderfe70a = $valueHolderfe70a;
        return $this->valueHolderfe70a->getExpressionBuilder();
    }
    public function beginTransaction()
    {
        $this->initializerdc9e5 && ($this->initializerdc9e5->__invoke($valueHolderfe70a, $this, 'beginTransaction', array(), $this->initializerdc9e5) || 1) && $this->valueHolderfe70a = $valueHolderfe70a;
        return $this->valueHolderfe70a->beginTransaction();
    }
    public function getCache()
    {
        $this->initializerdc9e5 && ($this->initializerdc9e5->__invoke($valueHolderfe70a, $this, 'getCache', array(), $this->initializerdc9e5) || 1) && $this->valueHolderfe70a = $valueHolderfe70a;
        return $this->valueHolderfe70a->getCache();
    }
    public function transactional($func)
    {
        $this->initializerdc9e5 && ($this->initializerdc9e5->__invoke($valueHolderfe70a, $this, 'transactional', array('func' => $func), $this->initializerdc9e5) || 1) && $this->valueHolderfe70a = $valueHolderfe70a;
        return $this->valueHolderfe70a->transactional($func);
    }
    public function wrapInTransaction(callable $func)
    {
        $this->initializerdc9e5 && ($this->initializerdc9e5->__invoke($valueHolderfe70a, $this, 'wrapInTransaction', array('func' => $func), $this->initializerdc9e5) || 1) && $this->valueHolderfe70a = $valueHolderfe70a;
        return $this->valueHolderfe70a->wrapInTransaction($func);
    }
    public function commit()
    {
        $this->initializerdc9e5 && ($this->initializerdc9e5->__invoke($valueHolderfe70a, $this, 'commit', array(), $this->initializerdc9e5) || 1) && $this->valueHolderfe70a = $valueHolderfe70a;
        return $this->valueHolderfe70a->commit();
    }
    public function rollback()
    {
        $this->initializerdc9e5 && ($this->initializerdc9e5->__invoke($valueHolderfe70a, $this, 'rollback', array(), $this->initializerdc9e5) || 1) && $this->valueHolderfe70a = $valueHolderfe70a;
        return $this->valueHolderfe70a->rollback();
    }
    public function getClassMetadata($className)
    {
        $this->initializerdc9e5 && ($this->initializerdc9e5->__invoke($valueHolderfe70a, $this, 'getClassMetadata', array('className' => $className), $this->initializerdc9e5) || 1) && $this->valueHolderfe70a = $valueHolderfe70a;
        return $this->valueHolderfe70a->getClassMetadata($className);
    }
    public function createQuery($dql = '')
    {
        $this->initializerdc9e5 && ($this->initializerdc9e5->__invoke($valueHolderfe70a, $this, 'createQuery', array('dql' => $dql), $this->initializerdc9e5) || 1) && $this->valueHolderfe70a = $valueHolderfe70a;
        return $this->valueHolderfe70a->createQuery($dql);
    }
    public function createNamedQuery($name)
    {
        $this->initializerdc9e5 && ($this->initializerdc9e5->__invoke($valueHolderfe70a, $this, 'createNamedQuery', array('name' => $name), $this->initializerdc9e5) || 1) && $this->valueHolderfe70a = $valueHolderfe70a;
        return $this->valueHolderfe70a->createNamedQuery($name);
    }
    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializerdc9e5 && ($this->initializerdc9e5->__invoke($valueHolderfe70a, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializerdc9e5) || 1) && $this->valueHolderfe70a = $valueHolderfe70a;
        return $this->valueHolderfe70a->createNativeQuery($sql, $rsm);
    }
    public function createNamedNativeQuery($name)
    {
        $this->initializerdc9e5 && ($this->initializerdc9e5->__invoke($valueHolderfe70a, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializerdc9e5) || 1) && $this->valueHolderfe70a = $valueHolderfe70a;
        return $this->valueHolderfe70a->createNamedNativeQuery($name);
    }
    public function createQueryBuilder()
    {
        $this->initializerdc9e5 && ($this->initializerdc9e5->__invoke($valueHolderfe70a, $this, 'createQueryBuilder', array(), $this->initializerdc9e5) || 1) && $this->valueHolderfe70a = $valueHolderfe70a;
        return $this->valueHolderfe70a->createQueryBuilder();
    }
    public function flush($entity = null)
    {
        $this->initializerdc9e5 && ($this->initializerdc9e5->__invoke($valueHolderfe70a, $this, 'flush', array('entity' => $entity), $this->initializerdc9e5) || 1) && $this->valueHolderfe70a = $valueHolderfe70a;
        return $this->valueHolderfe70a->flush($entity);
    }
    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializerdc9e5 && ($this->initializerdc9e5->__invoke($valueHolderfe70a, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerdc9e5) || 1) && $this->valueHolderfe70a = $valueHolderfe70a;
        return $this->valueHolderfe70a->find($className, $id, $lockMode, $lockVersion);
    }
    public function getReference($entityName, $id)
    {
        $this->initializerdc9e5 && ($this->initializerdc9e5->__invoke($valueHolderfe70a, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializerdc9e5) || 1) && $this->valueHolderfe70a = $valueHolderfe70a;
        return $this->valueHolderfe70a->getReference($entityName, $id);
    }
    public function getPartialReference($entityName, $identifier)
    {
        $this->initializerdc9e5 && ($this->initializerdc9e5->__invoke($valueHolderfe70a, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializerdc9e5) || 1) && $this->valueHolderfe70a = $valueHolderfe70a;
        return $this->valueHolderfe70a->getPartialReference($entityName, $identifier);
    }
    public function clear($entityName = null)
    {
        $this->initializerdc9e5 && ($this->initializerdc9e5->__invoke($valueHolderfe70a, $this, 'clear', array('entityName' => $entityName), $this->initializerdc9e5) || 1) && $this->valueHolderfe70a = $valueHolderfe70a;
        return $this->valueHolderfe70a->clear($entityName);
    }
    public function close()
    {
        $this->initializerdc9e5 && ($this->initializerdc9e5->__invoke($valueHolderfe70a, $this, 'close', array(), $this->initializerdc9e5) || 1) && $this->valueHolderfe70a = $valueHolderfe70a;
        return $this->valueHolderfe70a->close();
    }
    public function persist($entity)
    {
        $this->initializerdc9e5 && ($this->initializerdc9e5->__invoke($valueHolderfe70a, $this, 'persist', array('entity' => $entity), $this->initializerdc9e5) || 1) && $this->valueHolderfe70a = $valueHolderfe70a;
        return $this->valueHolderfe70a->persist($entity);
    }
    public function remove($entity)
    {
        $this->initializerdc9e5 && ($this->initializerdc9e5->__invoke($valueHolderfe70a, $this, 'remove', array('entity' => $entity), $this->initializerdc9e5) || 1) && $this->valueHolderfe70a = $valueHolderfe70a;
        return $this->valueHolderfe70a->remove($entity);
    }
    public function refresh($entity)
    {
        $this->initializerdc9e5 && ($this->initializerdc9e5->__invoke($valueHolderfe70a, $this, 'refresh', array('entity' => $entity), $this->initializerdc9e5) || 1) && $this->valueHolderfe70a = $valueHolderfe70a;
        return $this->valueHolderfe70a->refresh($entity);
    }
    public function detach($entity)
    {
        $this->initializerdc9e5 && ($this->initializerdc9e5->__invoke($valueHolderfe70a, $this, 'detach', array('entity' => $entity), $this->initializerdc9e5) || 1) && $this->valueHolderfe70a = $valueHolderfe70a;
        return $this->valueHolderfe70a->detach($entity);
    }
    public function merge($entity)
    {
        $this->initializerdc9e5 && ($this->initializerdc9e5->__invoke($valueHolderfe70a, $this, 'merge', array('entity' => $entity), $this->initializerdc9e5) || 1) && $this->valueHolderfe70a = $valueHolderfe70a;
        return $this->valueHolderfe70a->merge($entity);
    }
    public function copy($entity, $deep = false)
    {
        $this->initializerdc9e5 && ($this->initializerdc9e5->__invoke($valueHolderfe70a, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializerdc9e5) || 1) && $this->valueHolderfe70a = $valueHolderfe70a;
        return $this->valueHolderfe70a->copy($entity, $deep);
    }
    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializerdc9e5 && ($this->initializerdc9e5->__invoke($valueHolderfe70a, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerdc9e5) || 1) && $this->valueHolderfe70a = $valueHolderfe70a;
        return $this->valueHolderfe70a->lock($entity, $lockMode, $lockVersion);
    }
    public function getRepository($entityName)
    {
        $this->initializerdc9e5 && ($this->initializerdc9e5->__invoke($valueHolderfe70a, $this, 'getRepository', array('entityName' => $entityName), $this->initializerdc9e5) || 1) && $this->valueHolderfe70a = $valueHolderfe70a;
        return $this->valueHolderfe70a->getRepository($entityName);
    }
    public function contains($entity)
    {
        $this->initializerdc9e5 && ($this->initializerdc9e5->__invoke($valueHolderfe70a, $this, 'contains', array('entity' => $entity), $this->initializerdc9e5) || 1) && $this->valueHolderfe70a = $valueHolderfe70a;
        return $this->valueHolderfe70a->contains($entity);
    }
    public function getEventManager()
    {
        $this->initializerdc9e5 && ($this->initializerdc9e5->__invoke($valueHolderfe70a, $this, 'getEventManager', array(), $this->initializerdc9e5) || 1) && $this->valueHolderfe70a = $valueHolderfe70a;
        return $this->valueHolderfe70a->getEventManager();
    }
    public function getConfiguration()
    {
        $this->initializerdc9e5 && ($this->initializerdc9e5->__invoke($valueHolderfe70a, $this, 'getConfiguration', array(), $this->initializerdc9e5) || 1) && $this->valueHolderfe70a = $valueHolderfe70a;
        return $this->valueHolderfe70a->getConfiguration();
    }
    public function isOpen()
    {
        $this->initializerdc9e5 && ($this->initializerdc9e5->__invoke($valueHolderfe70a, $this, 'isOpen', array(), $this->initializerdc9e5) || 1) && $this->valueHolderfe70a = $valueHolderfe70a;
        return $this->valueHolderfe70a->isOpen();
    }
    public function getUnitOfWork()
    {
        $this->initializerdc9e5 && ($this->initializerdc9e5->__invoke($valueHolderfe70a, $this, 'getUnitOfWork', array(), $this->initializerdc9e5) || 1) && $this->valueHolderfe70a = $valueHolderfe70a;
        return $this->valueHolderfe70a->getUnitOfWork();
    }
    public function getHydrator($hydrationMode)
    {
        $this->initializerdc9e5 && ($this->initializerdc9e5->__invoke($valueHolderfe70a, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializerdc9e5) || 1) && $this->valueHolderfe70a = $valueHolderfe70a;
        return $this->valueHolderfe70a->getHydrator($hydrationMode);
    }
    public function newHydrator($hydrationMode)
    {
        $this->initializerdc9e5 && ($this->initializerdc9e5->__invoke($valueHolderfe70a, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializerdc9e5) || 1) && $this->valueHolderfe70a = $valueHolderfe70a;
        return $this->valueHolderfe70a->newHydrator($hydrationMode);
    }
    public function getProxyFactory()
    {
        $this->initializerdc9e5 && ($this->initializerdc9e5->__invoke($valueHolderfe70a, $this, 'getProxyFactory', array(), $this->initializerdc9e5) || 1) && $this->valueHolderfe70a = $valueHolderfe70a;
        return $this->valueHolderfe70a->getProxyFactory();
    }
    public function initializeObject($obj)
    {
        $this->initializerdc9e5 && ($this->initializerdc9e5->__invoke($valueHolderfe70a, $this, 'initializeObject', array('obj' => $obj), $this->initializerdc9e5) || 1) && $this->valueHolderfe70a = $valueHolderfe70a;
        return $this->valueHolderfe70a->initializeObject($obj);
    }
    public function getFilters()
    {
        $this->initializerdc9e5 && ($this->initializerdc9e5->__invoke($valueHolderfe70a, $this, 'getFilters', array(), $this->initializerdc9e5) || 1) && $this->valueHolderfe70a = $valueHolderfe70a;
        return $this->valueHolderfe70a->getFilters();
    }
    public function isFiltersStateClean()
    {
        $this->initializerdc9e5 && ($this->initializerdc9e5->__invoke($valueHolderfe70a, $this, 'isFiltersStateClean', array(), $this->initializerdc9e5) || 1) && $this->valueHolderfe70a = $valueHolderfe70a;
        return $this->valueHolderfe70a->isFiltersStateClean();
    }
    public function hasFilters()
    {
        $this->initializerdc9e5 && ($this->initializerdc9e5->__invoke($valueHolderfe70a, $this, 'hasFilters', array(), $this->initializerdc9e5) || 1) && $this->valueHolderfe70a = $valueHolderfe70a;
        return $this->valueHolderfe70a->hasFilters();
    }
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializerdc9e5 = $initializer;
        return $instance;
    }
    public function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config)
    {
        static $reflection;
        if (! $this->valueHolderfe70a) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolderfe70a = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        }, $this, 'Doctrine\\ORM\\EntityManager')->__invoke($this);
        }
        $this->valueHolderfe70a->__construct($conn, $config);
    }
    public function & __get($name)
    {
        $this->initializerdc9e5 && ($this->initializerdc9e5->__invoke($valueHolderfe70a, $this, '__get', ['name' => $name], $this->initializerdc9e5) || 1) && $this->valueHolderfe70a = $valueHolderfe70a;
        if (isset(self::$publicPropertiesdbf17[$name])) {
            return $this->valueHolderfe70a->$name;
        }
        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolderfe70a;
    ...
    {
        $this->initializerdc9e5 && ($this->initializerdc9e5->__invoke($valueHolderfe70a, $this, '__set', array('name' => $name, 'value' => $value), $this->initializerdc9e5) || 1) && $this->valueHolderfe70a = $valueHolderfe70a;
        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolderfe70a;
    ...
    {
        $this->initializerdc9e5 && ($this->initializerdc9e5->__invoke($valueHolderfe70a, $this, '__isset', array('name' => $name), $this->initializerdc9e5) || 1) && $this->valueHolderfe70a = $valueHolderfe70a;
        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolderfe70a;
    ...
    {
        $this->initializerdc9e5 && ($this->initializerdc9e5->__invoke($valueHolderfe70a, $this, '__unset', array('name' => $name), $this->initializerdc9e5) || 1) && $this->valueHolderfe70a = $valueHolderfe70a;
        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolderfe70a;
    ...
    {
        $this->initializerdc9e5 && ($this->initializerdc9e5->__invoke($valueHolderfe70a, $this, '__clone', array(), $this->initializerdc9e5) || 1) && $this->valueHolderfe70a = $valueHolderfe70a;
        $this->valueHolderfe70a = clone $this->valueHolderfe70a;
    }
    public function __sleep()
    {
        $this->initializerdc9e5 && ($this->initializerdc9e5->__invoke($valueHolderfe70a, $this, '__sleep', array(), $this->initializerdc9e5) || 1) && $this->valueHolderfe70a = $valueHolderfe70a;
        return array('valueHolderfe70a');
    }
    ...
    {
        $this->initializerdc9e5 = $initializer;
    }
    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializerdc9e5;
    }
    public function initializeProxy() : bool
    {
        return $this->initializerdc9e5 && ($this->initializerdc9e5->__invoke($valueHolderfe70a, $this, 'initializeProxy', array(), $this->initializerdc9e5) || 1) && $this->valueHolderfe70a = $valueHolderfe70a;
    }
    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolderfe70a;
    }
    public function getWrappedValueHolderValue()
    {
        return $this->valueHolderfe70a;
    }
}
...
class PaginatorInterface_82dac15 implements \ProxyManager\Proxy\VirtualProxyInterface, \Knp\Component\Pager\PaginatorInterface
{
    ...
    {
        $this->initializerdc9e5 && ($this->initializerdc9e5->__invoke($valueHolderfe70a, $this, 'paginate', array('target' => $target, 'page' => $page, 'limit' => $limit, 'options' => $options), $this->initializerdc9e5) || 1) && $this->valueHolderfe70a = $valueHolderfe70a;
        if ($this->valueHolderfe70a === $returnValue = $this->valueHolderfe70a->paginate($target, $page, $limit, $options)) {
            return $this;
        }
        return $returnValue;
    }
