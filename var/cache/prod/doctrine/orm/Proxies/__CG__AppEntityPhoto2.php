 ...
 */
class Photo2 extends \App\Entity\Photo2 implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Photo2' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Photo2' . "\0" . 'source', '' . "\0" . 'App\\Entity\\Photo2' . "\0" . 'prise'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Photo2 $proxy) {
    ...
    public function setPrise(\App\Entity\Prisedevue $prise = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setPrise', [$prise]);

        return parent::setPrise($prise);
    }
    ...
    public function getPrise()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPrise', []);

        return parent::getPrise();
    }
